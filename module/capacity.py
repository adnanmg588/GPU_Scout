...
def print_shape_list(home_region, config, signer, compartment_id):
    ...
    The following list was updated on january 19.
    This list is automatically refreshed when a new shape is detected in the connected region.
    """

    all_shapes = [ 'BM.DenseIO1.36', 'BM.DenseIO2.52', 'BM.DenseIO.E4.128', 'BM.DenseIO.E5.128', 
    ...
    'BM.Standard3.64', 'BM.Standard.A1.160', 'BM.Standard.B1.44', 
    'BM.Standard.E2.64', 'BM.Standard.E3.128', 'BM.Standard.E4.128', 
    'BM.Standard.E5.192', 'VM.DenseIO1.16', 'VM.DenseIO1.4', 'VM.DenseIO1.8', 
    'VM.DenseIO2.16', 'VM.DenseIO2.24', 'VM.DenseIO2.8', 'VM.DenseIO.E4.Flex', 
    'VM.DenseIO.E5.Flex', 'VM.GPU2.1', 'VM.GPU3.1', 'VM.GPU3.2', 'VM.GPU3.4', 
    'VM.GPU.A10.1', 'VM.GPU.A10.2', 'VM.Optimized3.Flex', 'VM.Standard1.1', 
    'VM.Standard1.16', 'VM.Standard1.2', 'VM.Standard1.4', 'VM.Standard1.8', 
    'VM.Standard2.1', 'VM.Standard2.16', 'VM.Standard2.2', 'VM.Standard2.24', 
    'VM.Standard2.4', 'VM.Standard2.8', 'VM.Standard3.Flex', 
    'VM.Standard.A1.Flex', 'VM.Standard.A2.Flex', 'VM.Standard.B1.1', 
    'VM.Standard.B1.16', 'VM.Standard.B1.2', 'VM.Standard.B1.4', 
    'VM.Standard.B1.8', 'VM.Standard.E2.1', 'VM.Standard.E2.1.Micro', 
    'VM.Standard.E2.2', 'VM.Standard.E2.4', 'VM.Standard.E2.8', 
    'VM.Standard.E3.Flex', 'VM.Standard.E4.Flex', 'VM.Standard.E5.Flex',
    # New GPU shapes added recently
    'VM.GPU.H100.1', 'VM.GPU.H100.2', 'BM.GPU.H100.4'
]
